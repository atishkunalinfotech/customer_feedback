...
class IndustriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create industry" do
    assert_difference('Industry.count') do
      post industries_url, params: { industry: { title: @industry.title, user_id: @industry.user_id } }
    end
  ...
  test "should update industry" do
    patch industry_url(@industry), params: { industry: { title: @industry.title, user_id: @industry.user_id } }
